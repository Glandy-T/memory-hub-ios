...
- 正式版四栏底部导航使用克制的状态动效：选中图标内部彩色分区拼合并轻微聚焦，未选中项保持安静；系统“移除动画”开启时即时切换，四项均保留 48×48dp 触控目标和 TalkBack 语义。
- 首页今日事项：横向真实卡片、上滑完成、下滑无视、撤销与凌晨 4 点日期边界。
- 日历：按日查看、新增事项，时间和备注可选；截止日与当日安排使用一致的清晰条目层级，周期规则按查看日期投影，操作后保留独立历史。已完成或已无视的事项、已完成截止日可重新设为待处理。
